...
const STATUS = {
  ...
  cancelled:        { label: 'Cancelled',       color: '#ef4444', bg: 'bg-red-50',     text: 'text-red-700',     dot: 'bg-red-400' },
  rejected:         { label: 'Rejected',        color: '#f97316', bg: 'bg-orange-50',  text: 'text-orange-700',  dot: 'bg-orange-400' },
}
